...
<div class="h-full flex flex-col bg-gray-100 dark:bg-gray-900 animate-in fade-in duration-200 transition-colors">
  ...
  <div class="flex items-center justify-between px-4 py-2 bg-white dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 shadow-sm shrink-0 h-[45px]">
      <div class="flex items-center gap-3 overflow-hidden">
          <button @click="goBack" class="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300 transition-colors" title="Back to List (Esc)">
              <ArrowLeft :size="20" />
          </button>
      ...
      <div class="flex gap-2 items-center">
          ...
          <button @click="goBack" class="p-1.5 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 rounded-md transition-colors text-gray-400" title="Close (Esc)">
              <X :size="20" />
          </button>
      </div>
  </div>
