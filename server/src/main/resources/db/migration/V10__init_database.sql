...
create table item_metadata (file_id bigint not null, filesize bigint not null, crypt_settings varchar(255) not null, filename varchar(255) not null, mimetype varchar(255) not null, sha256_canonical varchar(255) not null unique, sha256Stored varchar(255) not null, sha256original varchar(255) not null unique, source varchar(255) not null, primary key (file_id));
