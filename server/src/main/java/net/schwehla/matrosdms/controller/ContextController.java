...
import net.schwehla.matrosdms.domain.core.EArchiveFilter; // Updated Import
...
public class ContextController {
	...
	public ResponseEntity<List<MContext>> getAllInfoContext(
        ...
        // Need to update ContextService signature too, but for now we cast/adapt if ContextService hasn't changed its param type yet.
        // Assuming we keep ContextService simple for now using EStateFilter logic internally or update it.
        // For this patch I will assume ContextService accepts the new Enum or we map it.
